        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              passionné d'informatique depuis ma tendre enfance, j'ai entamé une reconversion professionnelle. Récemment diplômé en développement web, je continue à me former sur différents langages. Je serais ravi de vous accompagner dans la création de vos différents projets. Vous trouverez ci-dessous les différents languages que j'utilise et les projets que j'ai récemment réalisés. Bonne visite !
            </p>
